...
files.num = 83:120
files.id = [
    fill("LD_N2_BL21", length(83:85));
    fill("LD_N2_NGM", length(86:88));
    fill("LD_CB_BL21", length(89:90));
    fill("LD_CB_NGM", length(91:92));
    fill("LD_MT_BL21", length(93:96));
    fill("LD_MT_NGM", length(97:100));
    fill("M9_N2_BL21", length(101:103));
    fill("M9_N2_NGM", length(104:107));
    fill("M9_CB_BL21", length(108:111));
    fill("M9_CB_NGM", length(112:113));
    fill("M9_MT_BL21", length(114:117));
    fill("M9_MT_NGM", length(118:120))
]
